...
export declare const LANG_ALPHA_NUM = "[A-Z\\d]{1,8}";
export declare const LANG_SKIP_ALPHA_NUM = "[A-Z\\d]{2,8}";
export declare const LANG_PART = "(?:-[A-Z\\d]{1,8})*";
export declare const LANG_PART_SKIP = "(?:-[A-Z\\d]{2,8})*";
...
export declare const FORM_PARTS: Array<string>;
export declare const INPUT_BUTTON: Array<string>;
export declare const INPUT_CHECK: Array<string>;
export declare const INPUT_DATE: Array<string>;
export declare const INPUT_TEXT: Array<string>;
export declare const INPUT_EDIT: Array<string>;
export declare const INPUT_LTR: Array<string>;
export declare const ATTR_VALUE_I: Array<string>;
