...
export const KEY_INPUT_EDIT: Set<string>;
export const KEY_LOGICAL: Set<string>;
export const KEY_MODIFIER: Set<string>;
export const KEY_PS_ELEMENT: Set<string>;
export const KEY_PS_ELEMENT_FUNC: Set<string>;
export const KEY_PS_CLASS_STATE: Set<string>;
export const KEY_SHADOW_HOST: Set<string>;
