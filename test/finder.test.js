...
describe('Finder', () => {
  ...
  describe('match pseudo class selector', () => {
    ...
    it('should not match', () => {
      ...
      const finder = new Finder(window);
      finder.setup(':indeterminate', document.body);
      const res = finder._matchPseudoClassSelector(leaf, document.body, {});
      assert.strictEqual(res, false, 'result');
    });
    ...
    it('should match', () => {
      ...
      const finder = new Finder(window);
      finder.setup(':first-of-type', frag);
      const res = finder._matchPseudoClassSelector(leaf, node1, {});
      assert.strictEqual(res, true, 'result');
    });
    ...
    it('should not match', () => {
      ...
      frag.append(node1, node2);
      const finder = new Finder(window);
      finder.setup(':last-of-type', frag);
      const res = finder._matchPseudoClassSelector(leaf, node1, {});
      assert.strictEqual(res, false, 'result');
    });
    ...
    it('should not match', () => {
      ...
      frag.append(node1, node2);
      const finder = new Finder(window);
      finder.setup(':only-of-type', frag);
      const res = finder._matchPseudoClassSelector(leaf, node1, {});
      assert.strictEqual(res, false, 'result');
    });
  ...
  describe('get combined nodes', () => {
    it('should get matched nodes', () => {
      ...
      const nodes = new Set([document.getElementById('li1')]);
    ...
    it('should get matched nodes', () => {
      ...
      const nodes = new Set([document.getElementById('ul1')]);
