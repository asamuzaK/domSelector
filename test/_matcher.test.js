...
describe('match AST leaf and DOM node', () => {
  ...
  describe('Matcher', () => {
    ...
    describe('prepare #window, #document, #root', () => {
      it('should get result', () => {
        const matcher = new Matcher();
        const res = matcher._prepareDOM(document);
      ...
      it('should get result', () => {
        ...
        const matcher = new Matcher();
        const res = matcher._prepareDOM(parent);
        assert.deepEqual(res, [
          document.defaultView,
          document,
          document
      ...
      it('should get result', () => {
        ...
        document.body.appendChild(parent);
        const matcher = new Matcher();
        const res = matcher._prepareDOM(node);
        assert.deepEqual(res, [
          document.defaultView,
          document,
          document
      ...
      it('should get result', () => {
        ...
        const matcher = new Matcher();
        const res = matcher._prepareDOM(doc);
        assert.deepEqual(res, [
          doc.defaultView,
          doc,
          doc
      ...
      it('should get result', () => {
        ...
        const matcher = new Matcher();
        const res = matcher._prepareDOM(frag);
        assert.deepEqual(res, [
          document.defaultView,
          document,
          frag
      ...
      it('should throw', () => {
        const matcher = new Matcher();
        assert.throws(() => matcher._prepareDOM('foo'), TypeError,
      ...
      it('should throw', () => {
        ...
        const matcher = new Matcher();
        assert.throws(() => matcher._prepareDOM(text), TypeError,
    ...
    describe('correspond #ast and #nodes', () => {
      it('should throw', () => {
        const matcher = new Matcher();
        assert.throws(() => matcher._correspond('[foo==bar]'), DOMException,
      ...
      it('should throw', () => {
        const matcher = new Matcher();
        try {
          matcher._find('all', document, '[foo==bar]');
        } catch (e) {
      ...
      it('should throw', () => {
        const matcher = new Matcher();
        assert.throws(() => matcher._correspond(':lang("")'), DOMException);
      });

      it('should throw', () => {
        const matcher = new Matcher();
        try {
          matcher._find('all', document, 'li ++ li');
        } catch (e) {
          assert.instanceOf(e, DOMException);
          assert.strictEqual(e.message, 'Invalid selector li ++ li');
        }
        assert.throws(() => matcher._correspond('li ++ li'), DOMException,
          'Invalid selector li ++ li');
      });

      it('should get result', () => {
        const matcher = new Matcher();
        matcher._find('all', document, 'li:last-child, li:first-child + li');
        const res = matcher._correspond('li:last-child, li:first-child + li');
        assert.deepEqual(res, [
          [
            {
              branch: [
    ...
    describe('traverse tree walker', () => {
      it('should get matched node', () => {
        const matcher = new Matcher();
        matcher._find('all', document, 'ul');
        const res = matcher._traverse();
      ...
      it('should get matched node', () => {
        ...
        const matcher = new Matcher();
        matcher._find('all', document, 'ul');
        const res = matcher._traverse(node);
      ...
      it('should get matched node', () => {
        ...
        const matcher = new Matcher();
        matcher._find('all', document, 'ul');
        matcher._traverse(document.getElementById('li1'));
        const res = matcher._traverse(node);
        assert.deepEqual(res, node, 'result');
      });
    ...
    describe('collect nth child', () => {
      it('should not match', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(-1)');
      ...
      it('should get matched node(s)', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-last-child(6)');
        const res = matcher._collectNthChild(anb, node);
      ...
      it('should not match', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-last-child(-1n)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 0, 'size');
      });
      ...
      it('should not match', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(0)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 0, 'size');
      });
      ...
      it('should not match', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-last-child(0)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 0, 'size');
      });
      ...
      it('should get matched node(s)', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-last-child(1)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 1, 'size');
        assert.deepEqual([...res], [
      ...
      it('should get matched node(s)', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(1n)');
        const res = matcher._collectNthChild(anb, node);
      ...
      it('should get matched node(s)', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(1n+1)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 6, 'size');
        assert.deepEqual([...res], [
          node,
      ...
      it('should get matched node(s)', () => {
        ...
        const node = document.getElementById('dt1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(2n)');
        const res = matcher._collectNthChild(anb, node);
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(2n+1)');
        const res = matcher._collectNthChild(anb, node);
      ...
      it('should get matched node(s)', () => {
        ...
        const node = document.getElementById('li1');
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-last-child(2n+1)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 2, 'size');
        assert.deepEqual([...res], [
          node,
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', l1, ':nth-child(2 of .noted)');
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', l1, ':nth-last-child(2 of .noted)');
        const res = matcher._collectNthChild(anb, l1);
        assert.strictEqual(res.size, 1, 'size');
        assert.deepEqual([...res], [
          l7
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', l1, ':nth-child(2n of .noted)');
        const res = matcher._collectNthChild(anb, l1);
        assert.strictEqual(res.size, 2, 'size');
        assert.deepEqual([...res], [
          l4,
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', l1, ':nth-child(2n+1 of .noted)');
        const res = matcher._collectNthChild(anb, l1);
        assert.strictEqual(res.size, 2, 'size');
        assert.deepEqual([...res], [
          l2,
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', l1, ':nth-child(-n+3 of .noted)');
        const res = matcher._collectNthChild(anb, l1);
        assert.strictEqual(res.size, 3, 'size');
        assert.deepEqual([...res], [
          l2,
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(n)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 1, 'size');
        assert.deepEqual([...res], [
          node
      ...
      it('should get matched node(s)', () => {
        ...
        const matcher = new Matcher();
        matcher._find('self', node, ':nth-child(1 of .noted)');
        const res = matcher._collectNthChild(anb, node);
        assert.strictEqual(res.size, 1, 'size');
        assert.deepEqual([...res], [
          node
...
// restart from here
    ...
    describe('find matched node from tree walker', () => {
      it('should get matched node', () => {
        const matcher = new Matcher('ul', document);
        const [[{ branch: [{ leaves }] }]] = matcher._correspond('ul');
      ...
      it('should not match', () => {
        ...
        const [[{ branch: [{ leaves }] }]] = matcher._correspond('ol');
        const res = matcher._findNode(leaves);
        assert.isNull(res, 'result');
      });
      ...
      it('should get matched node', () => {
        ...
        const [[{ branch: [{ leaves }] }]] = matcher._correspond('li');
        const res = matcher._findNode(leaves);
    ...
    describe('find entry nodes', () => {
      it('should not match', () => {
        const matcher = new Matcher('::before', document);
        const [[{ branch: [twig] }]] = matcher._correspond('::before');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#ul1');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('ul1')
        ], 'nodes');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#ul1');
        const res = matcher._findEntryNodes(twig, 'self');
        assert.deepEqual([...res.nodes], [
          node
        ], 'nodes');
        assert.isFalse(res.compound, 'compound');
      ...
      it('should get matched node', () => {
        ...
        const matcher = new Matcher('#ul1', node);
        const [[{ branch: [twig] }]] = matcher._correspond('#ul1');
        const res = matcher._findEntryNodes(twig, 'lineal');
        assert.deepEqual([...res.nodes], [
          document.getElementById('ul1')
        ], 'nodes');
        assert.isFalse(res.compound, 'compound');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#li1.li');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('li1')
        ], 'nodes');
      ...
      it('should not match', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#li1.foobar');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('li1')
        ], 'nodes');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('ul#ul1');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('ul1')
        ], 'nodes');
      ...
      it('should not match', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#foobar');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isFalse(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should be pended', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#foobar');
        const res = matcher._findEntryNodes(twig, 'all');
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isFalse(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
        assert.isTrue(res.pending, 'pending');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('#li1:first-child');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('li1')
        ], 'nodes');
      ...
      it('should get matched node(s)', () => {
        const node = document.getElementById('ul1');
        const matcher = new Matcher('.li', node);
        const [[{ branch: [twig] }]] = matcher._correspond('.li');
        const res = matcher._findEntryNodes(twig, 'first');
        assert.deepEqual([...res.nodes], [
          document.getElementById('li1')
        ], 'nodes');
        assert.isFalse(res.compound, 'compound');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('.foo');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isFalse(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('li.li');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('li1'),
          document.getElementById('li2'),
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('.dd');
        const res = matcher._findEntryNodes(twig, 'self');
        assert.deepEqual([...res.nodes], [
          node
        ], 'nodes');
      ...
      it('should get matched node(s)', () => {
        const node = document.getElementById('ul1');
        const matcher = new Matcher('ul', node);
        const [[{ branch: [twig] }]] = matcher._correspond('ul');
        const res = matcher._findEntryNodes(twig, 'self');
        assert.deepEqual([...res.nodes], [
          node
        ], 'nodes');
      ...
      it('should not match', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('ol');
        const res = matcher._findEntryNodes(twig, 'lineal');
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isFalse(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('li:first-child');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          node
        ], 'nodes');
      ...
      it('should not match', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('dd:first-child');
        const res = matcher._findEntryNodes(twig, 'self');
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isTrue(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('li.li:last-child');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [
          document.getElementById('li1'),
          document.getElementById('li2'),
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('.foo.bar');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isTrue(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('div');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isFalse(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should not match', () => {
        ...
        const [[{ branch: [twig] }]] = matcher._correspond('p');
        const res = matcher._findEntryNodes(twig);
        assert.deepEqual([...res.nodes], [], 'nodes');
        assert.isFalse(res.compound, 'compound');
        assert.isFalse(res.filtered, 'filtered');
      ...
      it('should get matched node(s)', () => {
        const node = document.getElementById('li1');
        const matcher = new Matcher(':first-child', node);
        const [[{ branch: [twig] }]] = matcher._correspond(':first-child');
        const res = matcher._findEntryNodes(twig, 'self');
        assert.deepEqual([...res.nodes], [
          node
        ], 'nodes');
      ...
      it('should get matched node(s)', () => {
        ...
        const [[{ branch: [twig] }]] =
          matcher._correspond('[class]:first-child');
        const res = matcher._findEntryNodes(twig, 'self');
        assert.deepEqual([...res.nodes], [
          node
        ], 'nodes');
    ...
    describe('closest', () => {
      ...
      it('should get matched node', () => {
        ...
        const matcher = new Matcher('body > div', node);
        const res = matcher.closest();
        assert.deepEqual(res, target, 'result');
      });
