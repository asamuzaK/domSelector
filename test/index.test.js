...
describe('DOMSelector', () => {
  ...
  describe('DOMSelector', () => {
    ...
    it('should create instance', () => {
      ...
      assert.strictEqual(typeof res.onError, 'undefined',
        'onError is undefined');
      assert.strictEqual(typeof res.setup, 'undefined', 'setup is undefined');
      assert.strictEqual(typeof res.find, 'undefined', 'find is undefined');
...
describe('patched JSDOM', () => {
  ...
  describe('Element.matches()', () => {
    ...
    it('should get results', () => {
      ...
      p.appendChild(span);
      div.appendChild(p);
      assert.strictEqual(div.matches(':read-only'), false, 'not match :read-only');
      assert.strictEqual(div.matches(':read-write'), true, 'matches :read-write');
      assert.strictEqual(span.matches(':read-only'), false, 'not match :read-only');
      assert.strictEqual(span.matches(':read-write'), true, 'matches :read-write');
    });
  });
